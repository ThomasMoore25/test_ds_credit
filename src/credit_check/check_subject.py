...
_ALLOWED_CATEGORIES: Final[tuple[_Category, ...]] = (
    ...
    _Category(
        name="овощи и фрукты",
        keywords=(
            "овощи", "фрукты", "картофель", "морков", "капуст", "лук ", "чеснок",
            "томат", "огурц", "яблок", "груш", "ягод", "клубник", "малин",
            "плодов", "овощеводств",
        ),
        description="овощи, фрукты, ягоды (овощеводство, садоводство)",
    ),
    _Category(
        name="животноводство",
        keywords=(
            "крупн рогат скот", "крс", "поголовье", "стадо", "молочн",
            "скотовод", "свиновод", "овцевод", "птицевод", "животновод",
            "доильн", "коровник", "телятник", "свинарник",
        ),
        description="животноводство (КРС, свиноводство, овцеводство, птицеводство)",
    ),
    _Category(
    ...
    _Category(
        name="рыбоводство",
        keywords=(
            "рыбовод", "рыбхоз", "мальк", "корма для рыб", "пруд", "садков",
            "осетров", "форел", "карп ", "тілапія", "аквакультур",
        ),
        description="рыбоводство и аквакультура",
    ),
    _Category(
    ...
    _Category(
        ...
        keywords=(
            "лесхоз", "лесничеств", "саженц лесн", "лесовосстанов",
            "лесоразвед", "лесопосадк", "противопожарн лес", "рубк уход",
        ),
        description="лесное хозяйство и лесовосстановление",
    ),
    _Category(
...
_FORBIDDEN_KEYWORDS: Final[tuple[str, ...]] = (
    ...
    # IT и маркетинг
    "seo", "сайт", "разработка", "продвижение", "реклам", "маркетинг", "smm", "таргет", "контекстн",
    ...
    # Общепит и розница
    "ресторан", "кафе", "общепит", "розничн торговл", "продукты питания",
)
