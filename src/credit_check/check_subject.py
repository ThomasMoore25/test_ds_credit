...
_ALLOWED_CATEGORIES: Final[tuple[_Category, ...]] = (
    _Category(
        ...
        keywords=(
            ...
            "нитроаммофос", "азофос", "комплексн", "аммофос", "суперфосфат",
            "хлористый калий", "сульфат аммония", "диаммофоска",
            "гербицид", "фунгицид", "инсектицид", "пестицид", "ацетилцинк", "хлорокись меди",
    ...
    _Category(
        ...
        keywords=(
            ...
            "пропан-бутан", "сжиженный газ", "керосин", "мазут", "суг", "метан", "спгт",
        ),
    ...
    _Category(
        ...
        keywords=(
            ...
            "то трактор", "то комбайн", "фильтр", "ремень", "подшипник", "шланг", "гидроцилиндр",
        ),
